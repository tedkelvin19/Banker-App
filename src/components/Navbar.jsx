  ...
  <header>
    <nav className="w-full flex py-6 justify-between items-center navbar">
      ...
      <ul className="list-none sm:flex hidden justify-end items-center flex-1 text-white">
          <li className={`font-poppins font-normal cursor-pointer text-[16px] mr-10`}><Link href="/">Home</Link></li>
          ...
          <li className={`font-poppins font-normal cursor-pointer text-[16px]`}><Link href="/clients">Accounts</Link></li>
      </ul>
    </nav>
  </header>
